...
namespace Tools.Managers
{
	...
	{
        [SerializeField] private AudioDatabase soundDatabase;
        ...
        {
            AudioSourceType sourceType = soundDatabase.GetAudioEvent(sound).audioSourceType;
            soundDatabase.PlaySound(sound, GetAudioSource(sourceType));
        }
