...
[AddComponentMenu("KLabsAudioTools/AmbienceRandomLayer")]
...
//// _General Audio Settings_ /////
    ...
    private bool fadeIn = false, fadeOut = false, done = true, objectCreated = false;
    private float randVol; /// Volume Floats
